...
void LiquidCrystal::send(uint8_t value, uint8_t mode) {
 ...
 int character_table[] = {
	...
	0x50, 0x51, 0x52, 0x53, 0x54, 0x55, 0x56, 0x57, 0x58, 0x59, 0X5A, 0xFA, 0xA3, 0xFC, 0x1D, 0xC4, 
	0x27, 0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6A, 0x6B, 0x6C, 0x6D, 0x6E, 0x6F, 
	0x70, 0x71, 0x72, 0x73, 0x74, 0x75, 0x76, 0x77, 0x78, 0x79, 0x7A, 0xFD, 0xFE, 0xFF, 0xDF, 0xE1
  };
  ...
  if (_displayfunction & LCD_8BITMODE) {
    ...
    if (mode){
		value = character_table[(value & 0x7F)];
	}
    write4bits(value>>4);
    write4bits(value);
  }
